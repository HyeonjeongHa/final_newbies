                ...
                <div class = "degree">
                    ...
                    <div class="total-item-wrapper">
                        ...
                        <form method="POST" class="first item-wrapper" action="/basket">
                            ...
                            <input type="text" src="src" value="${item.src}" style="display: none" />
                            <input type="text" title="title" value="${item.title}" style="display: none" />
                            <input type="text" price="price" value="${item.price}" style="display: none" />
        ...
        <div class = "content wrapper">
            ...
            <div class="total-item-wrapper">
                ...
                <div class="first item-wrapper">
                    <img class="item-image" src="${item.src}"/></a>
                    <div class="item-title">${item.title}</div>
                    <div class = "item-price">${item.price}</div>
